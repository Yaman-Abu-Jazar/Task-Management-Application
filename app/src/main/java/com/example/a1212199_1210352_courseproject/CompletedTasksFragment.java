...
public class CompletedTasksFragment extends Fragment {
    ...
    public static currentTask currentTaskComplete;
    private Database db;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        taskContainer = rootView.findViewById(R.id.taskContainer1);
        db = new Database(getActivity(), "test4", null, 1);

        // Sample tasks
        List<currentTask> tasks = db.getCompletedTasks(user.getEmail());
...
//(int id, String title, String description, String priority, int completionStatus, String dueDate, String dueTime, String reminderDate, String reminderTime, User user)
            ...
            if (task != null && task.moveToFirst()) {
                currentTaskComplete = new currentTask(
                ...
                bundle.putSerializable("currentTask", currentTaskComplete);
